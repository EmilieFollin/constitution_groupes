...
CREATE TABLE IF NOT EXISTS `profil`.`code_personalite` (
  `idcode_personalite` INT NOT NULL,
  `code_personalite` VARCHAR(45) NULL,
  `code_personalite_idcode_personalite` INT NOT NULL,
  `x` INT NULL,
  `y` INT NULL,
  PRIMARY KEY (`idcode_personalite`, `code_personalite_idcode_personalite`),
  INDEX `fk_code_personalite_code_personalite_idx` (`code_personalite_idcode_personalite` ASC),
  CONSTRAINT `fk_code_personalite_code_personalite`
...
CREATE TABLE IF NOT EXISTS `profil`.`etudiant` (
  ...
  `code_personalite_idcode_personalite` INT NOT NULL,
  `code_personalite_code_personalite_idcode_personalite` INT NOT NULL,
  ...
  CONSTRAINT `fk_etudiant_code_personalite1`
    FOREIGN KEY (`code_personalite_idcode_personalite` , `code_personalite_code_personalite_idcode_personalite`)
    REFERENCES `profil`.`code_personalite` (`idcode_personalite` , `code_personalite_idcode_personalite`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION)
ENGINE = InnoDB;
...
CREATE TABLE IF NOT EXISTS `profil`.`projet` (
  ...
  `classe_professeur_idprofesseur` INT NOT NULL,
...
CREATE TABLE IF NOT EXISTS `profil`.`groupes` (
  ...
  `projet_classe_idclasse` INT NOT NULL,
  PRIMARY KEY (`idgroupes`, `projet_idprojet`, `projet_classe_idclasse`),
  INDEX `fk_groupes_projet1_idx` (`projet_idprojet` ASC, `projet_classe_idclasse` ASC),
...
-- -----------------------------------------------------
-- Table `profil`.`evaluation`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `profil`.`evaluation` (
...
-- -----------------------------------------------------
-- Table `profil`.`evaluation_has_etudiant`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `profil`.`evaluation_has_etudiant` (
  `evaluation_idevaluation` INT NOT NULL,
  `etudiant_idetudiant` INT NOT NULL,
  PRIMARY KEY (`evaluation_idevaluation`, `etudiant_idetudiant`),
  INDEX `fk_evaluation_has_etudiant_etudiant1_idx` (`etudiant_idetudiant` ASC),
  INDEX `fk_evaluation_has_etudiant_evaluation1_idx` (`evaluation_idevaluation` ASC),
  CONSTRAINT `fk_evaluation_has_etudiant_evaluation1`
    FOREIGN KEY (`evaluation_idevaluation`)
    REFERENCES `profil`.`evaluation` (`idevaluation`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION,
  CONSTRAINT `fk_evaluation_has_etudiant_etudiant1`
